...
library(MLAK)
attach(wczytajOdbiorce('R3-odbiorcy.csv', 'R3-dane.csv', 3))
...
wykresHistogram(ORANPK01[VAR15], 10,
  tytul = 'to jest tytuł to jest tytuł to jest tytuł to jest tytuł \nto jest tytuł to jest tytuł to jest tytuł to jest tytuł to jest tytuł', tytulX='tytuł osi X', tytulY='tytuł osi Y'
                )
```
