...
---------------------------------------------------- --------------------------------- ---------------------------------
Procent studentów, którzy terminowo uzyskali dyplom   `r E(dane$DTERM1[grupa37], 31)`%  `r E(dane$DTERM1[grupa38], 31)`%
(licząc od rozpoczęcia studiów)        

Procent studentów, którzy terminowo uzyskali dyplom   `r E(dane$DTERM2[grupa37], 31)`%  `r E(dane$DTERM2[grupa38], 31)`%
(licząc od rozpoczęcia ostatniego etapu studiów) 

Średnia liczba powtórzeń semestrów                      `r E(dane$LPOW[grupa37], 29)`%    `r E(dane$LPOW[grupa38], 29)`%

Średnia liczba warunkowych zaliczeń semestrów           `r E(dane$LWAR[grupa37], 29)`%    `r E(dane$LWAR[grupa38], 29)`%
------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------- --------------------------------- ---------------------------------
Procent studentów, którzy terminowo uzyskali dyplom   `r E(dane$DTERM1[grupa13], 31)`%  `r E(dane$DTERM1[grupa14], 31)`%
(licząc od rozpoczęcia studiów)        

Procent studentów, którzy terminowo uzyskali dyplom   `r E(dane$DTERM2[grupa13], 31)`%  `r E(dane$DTERM2[grupa14], 31)`%
(licząc od rozpoczęcia ostatniego etapu studiów) 

Średnia liczba powtórzeń semestrów                      `r E(dane$LPOW[grupa13], 29)`%    `r E(dane$LPOW[grupa14], 29)`%

Średnia liczba warunkowych zaliczeń semestrów           `r E(dane$LWAR[grupa13], 29)`%    `r E(dane$LWAR[grupa14], 29)`%
-----------------------------------------------------------------------------------------------------------------------------
...
Procent studentów, którzy terminowo uzyskali dyplom   `r E(dane$DTERM2[grupa32], 31)`%  `r E(dane$DTERM2[grupa33], 31)`%
(licząc od rozpoczęcia ostatniego etapu studiów) 

Średnia liczba powtórzeń semestrów                      `r E(dane$LPOW[grupa32], 29)`%    `r E(dane$LPOW[grupa33], 29)`%

Średnia liczba warunkowych zaliczeń semestrów           `r E(dane$LWAR[grupa32], 29)`%    `r E(dane$LWAR[grupa33], 29)`%
-----------------------------------------------------------------------------------------------------------------------------
